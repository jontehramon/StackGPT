...
const stackgptCommand = require('./commands/stackgpt');
    ...
    try {
        ...
        if (isBanned(senderId) && !userMessage.startsWith('.unban')) {
            ...
            if (Math.random() < 0.1) {
                await sock.sendMessage(chatId, {
                    text: '❌ You are banned from using StackGPT. Contact an admin or owner to get unbanned.',
                    ...channelInfo
                });
            }
            return;
      ...
      //  if (!message.key.fromMe) incrementMessageCount(chatId, senderId);
        ...
        if (isGroup && isAdminCommand) {
            ...
            if (!isBotAdmin) {
                await sock.sendMessage(chatId, { text: 'Please make StackGPT an admin to use admin commands.', ...channelInfo }, {quoted: message});
                return;
            }
        ...
        switch (true) {
            ...
            case userMessage.startsWith('.mode'):
                ...
                try {
                    ...
                    await sock.sendMessage(chatId, { text: `StackGPT is now in *${action}* mode`, ...channelInfo });
                } catch (error) {
            ...
            case userMessage === '.tagall':
                if (isSenderAdmin || message.key.fromMe) {
                    ...
                    await sock.sendMessage(chatId, { text: 'Only group admins can use the .tagall command.', ...channelInfo }, {quoted: message});
                }
                break;
            ...
            case userMessage.startsWith('.antilink'):
                ...
                if (!isBotAdmin) {
                    await sock.sendMessage(chatId, {
                        text: 'Please make StackGPT an admin first.',
                        ...channelInfo
                    });
                    return;
                }
            ...
            case userMessage.startsWith('.antibadword'):
                ...
                if (!isBotAdmin) {
                    await sock.sendMessage(chatId, { text: '*StackGPT must be admin to use this feature*', ...channelInfo });
                    return;
                }
           ...
           case userMessage.startsWith('.sinhalasub') || userMessage.startsWith('.movie'):
            ...
            case userMessage.startsWith('.instagram') || userMessage.startsWith('.insta') || userMessage.startsWith('.ig'):
                ...
                break;
                case userMessage.startsWith('.stackgpt') ||     userMessage.startsWith('.stackgpt') ||                userMessage.startsWith('.stackgpt'') ||           userMessage.startsWith('.stackgptdeepseek') ||
                 userMessage.startsWith('.stackgpt') ||

                 userMessage.startsWith('.stackgpt'):

                await stackgptCommand(sock, chatId, message);
